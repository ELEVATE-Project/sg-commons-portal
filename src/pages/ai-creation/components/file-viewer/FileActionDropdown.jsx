  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="h-[2.1875rem] flex items-center justify-center gap-[0.5rem] rounded-md border border-[#572E91] px-3 bg-[#572E91] font-['Manrope'] font-medium text-sm leading-none text-white"
      >
        <Icon />
        {label}
      </button>
